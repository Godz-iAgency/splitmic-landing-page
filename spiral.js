...
class AnimationController {
    ...
    render() {
        ...
        ctx.fillStyle = 'rgba(255, 255, 255, 0.6)'; // adjusted color slightly to fit light theme
...
function initSpiralAnimation() {
    ...
    function resize() {
        ...
        ctx.scale(dpr, dpr);
        animationController = new AnimationController(canvas, ctx, dpr, size);
    }
...
window.addEventListener('DOMContentLoaded', initSpiralAnimation);
